...
<div class="navbar navbar-fixed-bottom">
        ...
        <center style="color: white">Copyright &copy; 2014 ExamShow, All rights reserved Disclaimer</center>
...
<div class="modal-body">
 <form action="feedback" id="contact-form2" class="form-horizontal" method="post">
						      ...
						      <div class="controls">
                                                        ...
                                                        <input type="text" class="input-large span5" name="fname" id="fname" placeholder="Name" onkeyup="loadXMLDoc()"/>
                                                              <span id="err"> </span>
                                                    ...
                                                    <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                       <input type="text" class="input-large span5" name="email" id="email" placeholder="Email address"/>
                                                       </div>
                                                    </div>
						    <div class="control-group">
						      <label class="control-label" for="number">Mobile No.</label>
						      <div class="controls">
                                                <input type="text" class="input-large span5" name="number" id="number" maxlength="10" placeholder="Mobile number"/>
					           </div>
                                                    </div>
                                                     <div class="control-group">
						      <label class="control-label" for="comment">Comment</label>
						      <div class="controls">
                                                        <textarea class="form-control span5" name="comment" id="comment" rows="8" placeholder="Put youe Comment......" required="true">
                                                        </textarea>
                                                        <span id="err"> </span>
                                                        </div>
						    </div>
